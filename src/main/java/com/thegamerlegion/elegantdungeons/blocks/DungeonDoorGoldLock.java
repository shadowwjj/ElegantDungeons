...
public class DungeonDoorGoldLock extends Block {
    public DungeonDoorGoldLock() {
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if(player.getHeldItemMainhand().getItem() == RegistryHandler.KEY_GOLD.get() || player.getHeldItemOffhand().getItem() == RegistryHandler.KEY_GOLD.get()) {
            ...
            if(player.getHeldItemMainhand().getItem() == RegistryHandler.KEY_GOLD.get() && !player.abilities.isCreativeMode){
