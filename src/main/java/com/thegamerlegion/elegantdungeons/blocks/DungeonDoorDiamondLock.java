...
public class DungeonDoorDiamondLock extends Block {
    public DungeonDoorDiamondLock() {
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        if(player.getHeldItemMainhand().getItem() == RegistryHandler.KEY_DIAMOND.get() || player.getHeldItemOffhand().getItem() == RegistryHandler.KEY_DIAMOND.get()) {
            ...
            if(player.getHeldItemMainhand().getItem() == RegistryHandler.KEY_DIAMOND.get() && !player.abilities.isCreativeMode){
