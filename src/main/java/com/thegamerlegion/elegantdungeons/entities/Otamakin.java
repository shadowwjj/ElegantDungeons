...
public class Otamakin extends MonsterEntity {

    public Otamakin(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected SoundEvent getAmbientSound() {
        return RegistryHandler.OTAMAKIN_AMBIENT.get(); }

    @Override
    protected SoundEvent getDeathSound() {
        return RegistryHandler.OTAMAKIN_DEATH.get();
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) {
        return RegistryHandler.OTAMAKIN_HURT.get();
    }
